...
export default function PrivacyPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-purple-500/30 selection:text-purple-200 relative overflow-hidden font-sans">
      {/* Background Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 -z-10 h-[400px] w-[600px] rounded-full bg-purple-600/5 blur-[120px] pointer-events-none" />
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 space-y-12">
        ...
        <div className="text-center md:text-left space-y-4">
          ...
          <h1 className="text-3xl font-extrabold text-white">Prinsip Keamanan & Kepercayaan Coretify</h1>
        ...
        <div className="space-y-6">
          ...
          {/* Item 1: Read only */}
          <Card className="bg-slate-900/30 border-slate-900 p-6 space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-[11px] text-slate-400 pl-7">
              <div className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-rose-500" /> Tidak bisa mengirim email</div>
              <div className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-rose-500" /> Tidak bisa mengedit/mengubah berkas</div>
              <div className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-rose-500" /> Tidak bisa menghapus dokumen</div>
              <div className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-rose-500" /> Tidak bisa mengubah calendar event</div>
            </div>
          </Card>
        ...
        <div className="border-t border-slate-900 pt-8 text-center space-y-4">
          ...
          <Button
            ...
            className="bg-purple-600 hover:bg-purple-500 text-white font-semibold text-xs rounded-xl px-6 py-4 shadow"
          >
